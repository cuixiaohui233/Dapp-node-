...
let deployedContract = VotingContract.new(null,{data: byteCode, from: '0xa7d4831d700991304d690a078c6e65c5c281492c', gas: 4700000});
...
//测试合约调用
// console.log(contractInstance.getAddress())
// console.log(contractInstance.isChange(1529265844))
// contractInstance.writeOrder(37249608,'cxh',1528878748,{from: web3.eth.accounts[0]});// 1528878739
// contractInstance.writeOrder(37249607,'hxc',1528878739,{from: web3.eth.accounts[0]});// 1528878739
// console.log('写入的数据是', contractInstance.writeOrder(37249608,'cxh',1528878739,{from: web3.eth.accounts[0]}));
// console.log('合约账号',web3.eth.accounts[0]);
// contractInstance.writeOrder(37249608,'Jack',{from: web3.eth.accounts[0]});
console.log(contractInstance.readOrder.call(37249607));
// console.log(contractInstance.isOwner());
// console.log(contractInstance.writeOrder(1234));
